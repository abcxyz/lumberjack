...
public class CloudLoggingProcessor implements LogBackend {
  ...
  public AuditLogRequest process(AuditLogRequest auditLogRequest) throws LogProcessingException {
    try {
      //Need the proto field names to make the format consistent with that generated by Golang client.
      LogEntry entry =
          LogEntry.newBuilder(
                  Payload.JsonPayload.of(
                      mapper.readValue(
                          JsonFormat.printer()
                              .preservingProtoFieldNames() //Need the proto field names to make the format consistent with that generated by Golang client.
