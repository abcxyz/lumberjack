...
public class CloudLoggingProcessor implements LogBackend {
  ...
  public AuditLogRequest process(AuditLogRequest auditLogRequest) throws LogProcessingException {
    try {
      ...
      LogEntry.Builder entryBuilder =
          LogEntry.newBuilder(
                  Payload.JsonPayload.of(
                      mapper.readValue(
                          JsonFormat.printer()
                              // Need the proto field names to make the format consistent with that
                              // generated by Golang client.
      ...
      System.out.print("suhongq write log: " + logging.hashCode() + " " + entry);
      logging.write(Collections.singleton(entry));
      System.out.print("suhongq done write log: " + logging.hashCode() + " " + entry);
  ...
  @Override
  public void close() {
    System.out.println("cloud logging process closing " + logging.hashCode());
    logging.flush();
    System.out.println("cloud logging process close succeed " + logging.hashCode());
  }
