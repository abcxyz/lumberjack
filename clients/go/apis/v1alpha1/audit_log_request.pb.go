...
var file_audit_log_request_proto_rawDesc = string([]byte{
...
var (
	...
	file_audit_log_request_proto_rawDescData []byte
)

func file_audit_log_request_proto_rawDescGZIP() []byte {
	file_audit_log_request_proto_rawDescOnce.Do(func() {
		file_audit_log_request_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_audit_log_request_proto_rawDesc), len(file_audit_log_request_proto_rawDesc)))
	})
...
var file_audit_log_request_proto_goTypes = []any{
...
func file_audit_log_request_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_audit_log_request_proto_rawDesc), len(file_audit_log_request_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   2,
			NumExtensions: 1,
			NumServices:   0,
